...
2. **What is the difference between a list and a tuple?**
   A list (`[]`) is ordered and mutable — items can be added, removed, or changed after creation. A tuple (`()`) is ordered but immutable — once created, its contents cannot be changed.
